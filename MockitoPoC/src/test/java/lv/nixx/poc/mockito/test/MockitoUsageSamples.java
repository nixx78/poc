...
public class MockitoUsageSamples {
	...
	*/
	...
	public void customArgumentMatchersSample() throws Exception {
		...
		Matcher<String> m = new ArgumentMatcher<String>() {
			@Override
		...
		when(mockedObject.processMethod(argThat(m))).thenReturn("returnedValue");
...
//		assertThat(mockedObject.getStringValue(), org.hamcrest.Matchers.startsWith("_") );
	...
	interface InterfaceForTest {
	 ...
	 class InterfaceForTestImpl implements InterfaceForTest {
