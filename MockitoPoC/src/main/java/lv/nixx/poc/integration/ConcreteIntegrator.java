...
import lv.nixx.poc.service.BWService;
import lv.nixx.poc.service.BWServiceImpl;
import lv.nixx.poc.service.dao.BankSystemDAO;
import lv.nixx.poc.service.dao.BankSystemDAOImpl;
...
public class ConcreteIntegrator implements Integrator {
	...
	private Logger logger = LoggerFactory.getLogger( ConcreteIntegrator.class.getName() );
