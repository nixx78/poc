...
@RestController
@RequestMapping("/calculator_interceptor")
public class CalculatorControllerForInterceptor {

    private final CalculatorService calculatorService;

    @Autowired
    public CalculatorControllerForInterceptor(CalculatorService calculatorService) {
